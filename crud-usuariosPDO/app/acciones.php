...
function accionContarUsuarios()
{
    $db = AccesoDatos::getModelo();
    $totalUsuarios = $db->contarTotalUsuarios();

    // Incluye la vista para mostrar el total de usuarios
    include_once "layout/contar_usuarios.php";
    exit();
}
