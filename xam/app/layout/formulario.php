            ...
            <form method="POST">
                <table>
                    ...
                    <tr>
                        <td>Bloqueo</td>
                        <td>
                            <input type="text" name="bloqueo" value="<?= $user->bloqueo ?>" <?= ($orden == "Detalles") ? "readonly" : "" ?> size=10>
                        </td>
                    </tr>
                    <tr>
                        <td>Saldo </td>
                        <td>
                            <input type="text" name="saldo" value="<?= $user->saldo ?>" <?= ($orden == "Detalles") ? "readonly" : "" ?> size=10>
                        </td>
                    </tr>
                    <tr>
                        <td>Comentario </td>
