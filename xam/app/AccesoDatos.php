...
class AccesoDatos
{
    ...
    public function addUsuario($user): bool
    {
        ...
        $this->stmt_creauser->execute([$user->nombre, $user->login, $user->password, 0, $user->saldo, $user->comentario]);
    ...
    if (count($seleccionados) <= 1) {
        ...
        $msgBloqueo = "Por favor, seleccione solo un usuario para realizar esta acción.";
        echo "<script>alert('$msgBloqueo');</script>";
    }
